...
function Present() {
  return (
    <SectionWrapper>
      <div className='mb-64'>
        <h1 className="absolute -top-[7rem] left-0 right-0 text-center flex items-center justify-center text-xl font-extrabold text-pink-600 drop-shadow-lg">
        ...
        <label className='gift' htmlFor='click'>
          ...
          <div id="raffle-red" className="entry raffle raffle-1">
            <div className="no-scale">
              <span className="ticket-text">me<br/>hehehe</span>
            </div>
          </div>
          ...
          <div id="raffle-red" className="entry raffle raffle-3">
            <div className="no-scale">
              <span className="ticket-text">Free<br/>Chores</span>
            </div>
          </div>
        </label>
      </div>
